...
<button
	...
	class="relative overflow-hidden cursor-pointer text-start group rounded-xl flex flex-col h-45 max-w-100 w-full md:w-70 lg:w-70 border gap-3 hover:ring-blue-400 hover:ring-2 border-neutral-700 bg-neutral-800/60"
>
